...
public class MinesweeperDAO {
    ...
    public void createGame(MinesweeperGameDBO minesweeperGame) throws SQLException, URISyntaxException, JsonProcessingException {
        ...
        String json = mapper.writeValueAsString(minesweeperGame);
    ...
    public void updateGame(MinesweeperGameDBO minesweeperGameDBO) throws URISyntaxException, SQLException, JsonProcessingException {
        Connection connection = getConnection();
    ...
    public MinesweeperGameDBO loadGame(long gameId) throws URISyntaxException, SQLException, JsonProcessingException {
        Connection connection = getConnection();
